bundle install
rails g model History start_time:datetime start_time_display:string stop_time_display:string valve_id:integer --force
rails g model Sprinkle next_start_time:datetime state:string time_input:string duration:integer valve_id:integer state:string --force
